...
function showWinDialog(t) {
    if (gameInfo.setBlinking(!1), "hvh" === t.mode) {
        ...
        $("#game-won h4").html(e + " 赢了！"), gameInfo.value = e + " won.", $("#win-content").html(e + " 赢了比赛。再来一次？"), $("#happy-outer").fadeIn(500)
    } else t.getCurrentPlayer() instanceof HumanPlayer ? ($("#game-won h4").html("你赢了！"), $("#win-content").html("你赢了比赛。再来一次？"), gameInfo.value = "你赢了。", $("#sad-outer").fadeIn(500)) : ($("#game-won h4").html("你输了。"), $("#win-content").html("垃圾，你输给了电脑。再玩一次？"), gameInfo.value = "Computer won.", $("#happy-outer").fadeIn(500))
}
Player.prototype.myTurn = function () {
    ...
    this.game.setCurrentColor(this.color), gameInfo.setText(function (t) {
        return t.charAt(0).toUpperCase() + t.slice(1)
    }(a) + " 落子"), gameInfo.setColor(this.color), gameInfo.setBlinking(!1)
