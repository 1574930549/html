...
$('#txt').keydown(function(ev) {
    ...
    $(function() {
        ...
        // $('#box ul').html() === '' ? $('#box').css('height', '0px') : $('#box').css('height', 'auto');
        $.getJSON("js/sousuo.json",function(result){
        ...
        for (var i = 0; i < search.data.length; i++) {
            ...
            var t = '<li><svg class="icon" aria-hidden = "true" ><use xlink:href="#' + search.data[i].img + '"></use></svg>' + search.data[i].name + "</li > ";
