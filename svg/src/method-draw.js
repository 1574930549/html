  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    curConfig = {
      ...
      uiStrings = Editor.uiStrings = {
        ...
        notification: {
          "invalidAttrValGiven":"给定值无效",
          "noContentToFitTo":"没有内容",
          "dupeLayerName":"已有图层应用此名称",
          "enterUniqueLayerName":"请输入唯一的图层名称",
          "enterNewLayerName":"请输入新的图层名称",
          "layerHasThatName":"图层已经有这个名字了",
          "QmoveElemsToLayer":"所选元素移动到图层 \"%s\"?",
          "QwantToClear":"<strong>确定要清除图纸吗？</strong>\n这也将清除您的撤消历史记录",
          "QwantToOpen":"确定要打开新文件吗？?\n这也将清除您的撤消历史记录",
          "QerrorsRevertToSource":"SVG源文件中有解析错误。\n恢复原始SVG源?",
          "QignoreSourceChanges":"忽略对SVG源所做的更改?",
          "featNotSupported":"功能不支持",
          "enterNewImgURL":"输入新的图片地址",
          "defsFailOnSave": "注意：由于浏览器中的错误，此图像可能显示错误（缺少渐变或元素）。 实际上保存后会正确显示。",
          "loadingImage":"正在加载图片，请稍后...",
          "saveFromBrowser": "选择 \"另存为...\" 保存图片 %s .",
          "noteTheseIssues": "注意以下问题: ",
